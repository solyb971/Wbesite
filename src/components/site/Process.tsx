const steps = [
  { num: "01", title: "Échange découverte", description: "45 minutes pour comprendre votre activité et ce dont vous avez besoin — en visio ou en présentiel en Guadeloupe.", duration: "Jour 1 · Gratuit" },

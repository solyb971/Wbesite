        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              ...
              onMouseLeave={e => (e.currentTarget.style.color = '#736B5F')}
            >
          ...
          {navLinks.map((link) => {
            ...
            return (
              <a
                ...
                href={link.href}
                onClick={(e) => scrollToSection(e, link.href)}
                className={`py-3 px-3 rounded text-sm font-light cursor-pointer ${activeSection === hash ? 'text-[#0E0D0B]' : 'text-[#736B5F]'}`}
              >
                {link.label}
              </a>
            )

  ...
  return (
    <>
      ...
      <article className="min-h-screen bg-white">
        ...
        <header className="pt-6 pb-12 px-4 sm:px-6 lg:px-8" style={{ background: 'linear-gradient(135deg, rgba(196,71,42,0.06), rgba(232,132,95,0.05))' }}>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex items-center space-x-6 text-gray-600">
              <div className="flex items-center space-x-2"><Calendar className="w-5 h-5" /><span>12 mai 2026</span></div>
              <div className="flex items-center space-x-2"><Clock className="w-5 h-5" /><span>10 min de lecture</span></div>
            </div>
          </div>
        </header>
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-12">
          <div className="max-w-3xl mx-auto prose prose-lg prose-headings:font-display prose-a:text-[#C4472A]">
            ...
            <div className="not-prose rounded-2xl p-6 my-8" style={{ background: 'rgba(196,71,42,0.05)', border: '1px solid rgba(196,71,42,0.15)' }}>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr style={{ borderBottom: `2px solid ${RUST}` }}>
                      <th className="text-left py-3 px-3 text-gray-900">Prestataire</th>
                      <th className="text-left py-3 px-3 text-gray-900">Fourchette</th>
                      <th className="text-left py-3 px-3 text-gray-900">Délai moyen</th>
                    </tr>
                  </thead>
                  <tbody className="text-gray-700">
                    <tr className="border-b border-gray-200"><td className="py-3 px-3">Freelance local</td><td className="py-3 px-3">490 € – 2 000 €</td><td className="py-3 px-3">2 – 6 semaines</td></tr>
                    <tr className="border-b border-gray-200"><td className="py-3 px-3">Petite agence 971</td><td className="py-3 px-3">790 € – 3 500 €</td><td className="py-3 px-3">4 – 8 semaines</td></tr>
                    <tr className="border-b border-gray-200"><td className="py-3 px-3">Grande agence</td><td className="py-3 px-3">2 500 € – 8 000 €</td><td className="py-3 px-3">2 – 4 mois</td></tr>
              ...
              <p className="mt-5 mb-0 text-sm font-semibold" style={{ color: RUST }}>
            ...
            <div className="not-prose rounded-2xl p-6 my-8" style={{ background: 'rgba(196,71,42,0.05)', border: '1px solid rgba(196,71,42,0.15)' }}>
              <ul className="space-y-3 m-0 list-none p-0">
                <li className="text-gray-700"><strong className="text-gray-900">Budget serré (&lt; 800 €)</strong> — freelance local ou jeune agence, site vitrine simple mais soigné. Vérifiez les réalisations et que vous serez propriétaire.</li>
                <li className="text-gray-700"><strong className="text-gray-900">Budget moyen (800 – 2 000 €)</strong> — site vitrine complet, design sur-mesure, SEO local. Le meilleur rapport qualité/prix pour la plupart des TPE.</li>
                <li className="text-gray-700"><strong className="text-gray-900">Budget ambitieux (2 000 € +)</strong> — e-commerce, fonctionnalités avancées ou application métier sur mesure.</li>
              </ul>
            </div>
        ...
        {/* CTA Section */}
        <section className="py-16 px-4 sm:px-6 lg:px-8 text-center" style={{ background: 'linear-gradient(135deg, rgba(196,71,42,0.08), rgba(232,132,95,0.06))' }}>
          <div className="max-w-2xl mx-auto">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Envie d&apos;un devis clair, sans surprise ?
            </h2>
            <p className="text-lg text-gray-700 mb-8">
              SolYB affiche ses tarifs et vous livre un site vitrine professionnel en 2 semaines. Devis gratuit sous 24h, sans engagement.
            </p>
            <Link
              href="/#contact"
              className="inline-flex items-center gap-2 font-medium text-base transition-transform hover:-translate-y-px"
              style={{ background: RUST, color: '#fff', padding: '15px 32px', borderRadius: '4px' }}
            >
